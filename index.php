...
<body>
            ...
            echo '<div class="option">
                <nav>
                    <ul>
                        ...
                        <li><a href="">Đặt khám bác sĩ</a></li>
    ...
    <?php
        if(isset($_GET['dangnhap'])){
            include_once("view/Login/dangnhap.php");
        } else if(isset($_GET['dangky'])){
            include_once("view/Login/dangky.php");
        } else if(isset($_GET['hoso'])){
            include_once("view/Login/hoso.php");
        } else if(isset($_GET['capnhathoso'])){
            include_once("view/Login/capnhathoso.php");
        } else if(isset($_GET['lichkham'])){
            include_once("view/XemLichKham/xemlk.php");
        } else if(isset($_GET['bacsi'])){
            include_once("view/XemLichKham/xembs.php");
        } else if(isset($_GET['lichkhambs'])){
            include_once("view/XemLichKham/xemlkbs.php");
        } else {
            echo '<div class="list-dk">
                <div class="cl-top">
                    <div class="top">
